...
**[`Installation`](#installation)**  **[`Einrichtung`](#einrichtung)**  **[`Das Panel`](#das-panel)**  **[`Regeln`](#regeln)**  **[`Regelgruppen`](#regelgruppen)**  **[`Lovelace-Card`](#lovelace-card)**  **[`Automations-API`](#automations-api)**  **[`Entities`](#entities)**  **[`Einstellungen`](#einstellungen)**  **[`Wie es arbeitet`](#wie-es-arbeitet)**  **[`Sprachen`](#sprachen)**  **[`Transparenz`](#transparenz)**  **[`Lizenz`](#lizenz)**
...
<summary>Eine Sprache ergaenzen</summary>

<br>

Drei Stellen, je eine Datei:

1. `custom_components/notification_center/frontend/translations/<code>.js` anlegen — am besten als Kopie von `en.js` — und in `frontend/i18n.js` in `SPRACHEN` eintragen.
2. In `custom_components/notification_center/discovery/texte.py` einen Eintrag in `TEXTE` ergaenzen; das sind die Texte der Vorschlaege.
3. `custom_components/notification_center/translations/<code>.json` anlegen, nach dem Vorbild von `en.json`; das ist die Einrichtung in Home Assistant.

Fehlende Schluessel sind erlaubt: sie fallen auf Englisch zurueck. Die Tests pruefen, dass keine Sprache unbekannte Schluessel mitbringt und dass die Platzhalter zusammenpassen.
